...
export default class View {
    ...
    render(viewCmd, parameter) {
        switch (viewCmd) {
            ...
            case "clearCompletedButton":
                ...
                break;
            case "itemReorder":
                this._setupDragAndDrop(handler);
                break;
        }
    }
    ...
    _setupDragAndDrop(handler) {
        $delegate(this.$todoList, "li", "dragstart", (e) => {
        ...
        $delegate(this.$todoList, "li", "dragend", (e) => {
            e.target.classList.remove("dragging");
            
            qsa("li", this.$todoList).forEach(item => {
                item.classList.remove("drag-over");
            });
            
            const items = qsa("li", this.$todoList);
            const newOrder = [];
        ...
        $delegate(this.$todoList, "li", "dragover", (e) => {
            if (e.preventDefault) {
                e.preventDefault();
            }
            e.dataTransfer.dropEffect = "move";
            
            const afterElement = this._getDragAfterElement(this.$todoList, e.clientY);
        ...
        $delegate(this.$todoList, "li", "drop", (e) => {
    ...
    _getDragAfterElement(container, y) {
        const draggableElements = [...qsa("li:not(.dragging)", container)];
